export default function Page() {
  return (
    <div className="sm:mr-[16px] lg:mr-0 flex-1 flex flex-col items-center justify-center sm:min-h-[820px] lg:min-h-[900px] p-2 rounded-md gap-2 bg-neutral-50 mt-6">
