...
export default function Anime({ anime }: AnimeProps) {
  return (
    <div className="flex flex-col border border-black-750 w-[180px] sm:w-[200px] lg:w-[240px] h-[200px] sm:h-[220px] lg:h-[240px]">
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        <Image
          src={animeCd}
          alt="anime-cd"
          className="-ml-[36px] max-w-[180px] sm:max-w-[220px] lg:max-w-[280px]"
        />
